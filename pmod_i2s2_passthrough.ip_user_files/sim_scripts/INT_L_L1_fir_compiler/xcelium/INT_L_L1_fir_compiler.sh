...
#
# Script generated by Vivado on Sat Apr 11 12:46:11 -0600 2026
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : INT_L_L1_fir_compiler.sh
...
#
# Usage        : INT_L_L1_fir_compiler.sh
#                INT_L_L1_fir_compiler.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                INT_L_L1_fir_compiler.sh [-reset_run]
#                INT_L_L1_fir_compiler.sh [-reset_log]
#                INT_L_L1_fir_compiler.sh [-help]
#
...
#                script (type 'INT_L_L1_fir_compiler.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname xbip_utils_v3_0_13 -libname axi_utils_v2_0_9 -libname fir_compiler_v7_2_22 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm xbip_utils_v3_0_13 axi_utils_v2_0_9 fir_compiler_v7_2_22 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "INT_L_L1_fir_compiler.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./INT_L_L1_fir_compiler.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvhdl -work fir_compiler_v7_2_22 $xmvhdl_opts \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.INT_L_L1_fir_compiler xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.INT_L_L1_fir_compiler -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log INT_L_L1_fir_compiler_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./INT_L_L1_fir_compiler.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: INT_L_L1_fir_compiler.sh [-help]\n\
Usage: INT_L_L1_fir_compiler.sh [-step]\n\
Usage: INT_L_L1_fir_compiler.sh [-lib_map_path]\n\
Usage: INT_L_L1_fir_compiler.sh [-reset_run]\n\
Usage: INT_L_L1_fir_compiler.sh [-reset_log]\n\
Usage: INT_L_L1_fir_compiler.sh [-keep_index]\n\
Usage: INT_L_L1_fir_compiler.sh [-noclean_files]\n\n\
